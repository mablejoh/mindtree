...
const Header4 = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }) => {
    ...
    <header className={`main-header header-style-four ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
      <div className="main-box">
        <div className="mobile-nav-toggler" onClick={handleOpen}><i className="icon lnr-icon-bars"></i>Menu</div>
        <div className="logo-box">
          <div className="logo"><Link to="/"><img src={isDarkMode ? DarkLogo : MainLogo} alt="Image" title="Consultez"/></Link>
          </div>
        </div>
        ...
        <div className="outer-box">
          <div className="info-box">
            ...
            <Link className="btn-one" to="/page-contact">Get quote now</Link>
          </div>
        </div>
      </div>
