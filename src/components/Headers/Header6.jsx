...
const Header6 = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }) => {
    ...
    <header className={`main-header header-style-six ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
      <div className="auto-container px-12">
        <div className="main-box">
          ...
          <div className="outer-box">
            <div className="info-box">
              <a className="btn-three" to="/page-contact">Get quote now</a>
            </div>
