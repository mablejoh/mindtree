    ...
    <section id="service" className="service-section pt-120 pb-120">
      ...
      <div className="container">
        ...
        <div className="sec-title mb-50">
          <h6 className="sub-title wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Services </h6>
          <div className="flex-content">
            <h2 className="title wow splt-txt" data-splitting>What We Do </h2>
          ...
          <Swiper {...swiperOptions} className="swiper-wrapper">
            <SwiperSlide className="swiper-slide">
              <div className="service-block">
                <Link className="arry-btn" to="/audit-assuarance"><i className="fa-regular fa-arrow-up-right"></i></Link>
                <div className="content-box">
                  ...
                  <div className="content">
                    ...
                    <h4 className="title"><Link to="/audit-assuarance">AUDIT & ASSURANCE</Link></h4>
                    <p className="text">This is much more than verifying just figures and numbers. </p>
                  </div>
                </div>
            ...
            <SwiperSlide className="swiper-slide">
              <div className="service-block">
                <Link className="arry-btn" to="/business-advisory-services"><i className="fa-regular fa-arrow-up-right"></i></Link>
                <div className="content-box">
                  <div className="icon">
                  ...
                  <div className="content">
                    ...
                    <h4 className="title"><Link to="/business-advisory-services">BUSINESS ADVISORY</Link></h4>
                    <p className="text">To determine the financial structure and analyse the economic benefits</p>
                  </div>
                </div>
                <div className="image-box">
                  <figure className="image">
            ...
            <SwiperSlide className="swiper-slide">
              <div className="service-block">
                <Link className="arry-btn" to="/accounting-bookkeeping-service"><i className="fa-regular fa-arrow-up-right"></i></Link>
                <div className="content-box">
                  <div className="icon">
                  ...
                  <div className="content">
                    ...
                    <h4 className="title"><Link to="/accounting-bookkeeping-service">ACCOUNTING & BOOKKEEPING</Link></h4>
                    <p className="text">We provide our accounting services to all business segments and individuals with a better result.</p>
                  </div>
                </div>
                <div className="image-box">
                  <figure className="image">
            ...
            <SwiperSlide className="swiper-slide">
              <div className="service-block">
                <Link className="arry-btn" to="/company-setup"><i className="fa-regular fa-arrow-up-right"></i></Link>
                <div className="content-box">
                  <div className="icon">
                    <svg width="84" height="85" viewBox="0 0 84 85" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                  ...
                  <div className="content">
                    ...
                    <h4 className="title"><Link to="/company-setup">COMPANY SETUP</Link></h4>
                    <p className="text">Assist clients to set up their businesses making it a seamless process</p>
                  </div>
                </div>
                <div className="image-box">
                  <figure className="image">
            ...
            <SwiperSlide className="swiper-slide">
              <div className="service-block">
                <Link className="arry-btn" to="/taxation-services"><i className="fa-regular fa-arrow-up-right"></i></Link>
                <div className="content-box">
                  <div className="icon">
                    <svg width="92" height="93" viewBox="0 0 92 93" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                  ...
                  <div className="content">
                    ...
                    <h4 className="title"><Link to="/taxation-services">TAXATION</Link></h4>
                    <p className="text">We undertake VAT registration and help your company to obtain the Tax Registration Number.</p>
                  </div>
                </div>
                <div className="image-box">
                  <figure className="image">
