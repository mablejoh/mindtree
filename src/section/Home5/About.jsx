...
import Image1 from '../../assets/images/about/about-01.png';
import Image2 from '../../assets/images/about/about-user.png';
import Image3 from '../../assets/images/about/signature.png';

function About() {
    return (
        <>
        <section id="about" className="about-section-4 pt-120 pb-120">
                    ...
                    <div className="row g-4 align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="about-content">
                                ...
                                <h2 className="wow fadeInUp" data-wow-delay=".2s">The Journey Behind Our Finance Success</h2>
                                <p className="about-text wow fadeInUp mt-3" data-wow-delay=".6s">Business consulting is a dynamic and diverse field that plays a crucial role in helping organizations succeed competitive</p>
                                </div>                
                                <div className="about-icon-box">
                                    <div className="count-box wow fadeInUp" data-wow-delay=".3s">
                                        <h2><span className="count-text" data-speed="3000" data-stop="15"><CounterUp end={15} /></span>+</h2>
                                    ...
                                    <div className="icon-right">
                                        <div className="about-block wow fadeInUp" data-wow-delay=".6s">
                                            ...
                                            <div className="content">
                                                <h6 className="title">Creative Solutions</h6>
                                        ...
                                        <div className="inner-box">
                                            ...
                                            <div className="content">
                                            <h6 className="title">Actionable Solutions</h6>
                                ...
                                <div className="info mt-50">
                                    <Link to="/page-services" className="btn-two">Know More</Link>
                                    <div className="user">
                                        <div className="image">
                                        <img src={Image2} alt="Image"/>
                                        </div>
                                        <div>
                                        <img className="sig" src={Image3} alt="Image"/>
