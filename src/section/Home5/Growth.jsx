...
import GrowthImage1 from '../../assets/images/bg/growth-bg-2.jpg';
import GrowthImage2 from '../../assets/images/shape/growth-shape.png';
...
function Growth(){
  return (
    <>
    <section className="growth-section pt-120 pb-120" style={{ backgroundImage: `url(${GrowthImage1})` }} >
      <div className="sec-shape">
        <img src={GrowthImage2} alt="Growth Shape" className="sway_Y__animation" />
      </div>
      <div className="container">
        <div className="sec-title pb-50 mb-50">
          ...
          <div className="flex-content">
            <h2 className="title text-white wow splt-txt" data-splitting>Creating Financial <br/>Partnerships for Unlimited <br/>Growth.</h2>
