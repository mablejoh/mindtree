...
import Image1 from '../assets/images/resource/project-details-1.jpg';
import Image2 from '../assets/images/resource/project-details-2.jpg';
import Image3 from '../assets/images/resource/project-details-3.jpg';
import Image4 from '../assets/images/resource/project-details-4.jpg';
import Image5 from '../assets/images/resource/pagination-bar.png';
	...
	return (
		...
		<section className="project-details pt-120 pb-70">
			...
			<div className="row">
				...
				<Link className="btn-two" to="/page-contact">Visit Website <i className="fas fa-angle-right"></i></Link>
				</div>
				...
				<div className="project-details__content-right mt-0">
					...
					<ul className="list-unstyled project-details__details-list">
						...
						<p className="project-details__client"><Link to="#">yourdomain.com</Link></p>
						</li>
					</ul>
					</div>
				</div>
			...
			<div className="row mb-5 mb-lg-0">
				...
				<div className="project-details__top mt-5">
					<div className="project-details__img"> <img className="rounded-0" src={Image1} alt="Image"/> </div>
				</div>
				</div>
				<div className="col-lg-8 col-md-6">
				<div className="project-details__top mt-5">
					<div className="project-details__img"> <img className="rounded-0" src={Image2} alt="Image"/> </div>
				</div>
				</div>
			</div>
			...
			<div className="row">
				...
				<div className="project-details__top mt-5">
					<div className="project-details__img"> <img className="rounded-0" src={Image3} alt="Image"/></div>
				</div>
				</div>
				<div className="col-md-6">
				<div className="project-details__top mt-5">
					<div className="project-details__img"> <img className="rounded-0" src={Image4} alt="Image"/></div>
				</div>
				</div>
			</div>
			<div className="row">
				...
				<div className="project-details__pagination-box">
					...
					<li className="next text-start">
						...
						<h4 className="title"> <Link to="#">Business Website Design</Link> </h4>
					</li>
					<li className="count"><Link to="#"></Link></li>
					<li className="count"><Link to="#"></Link></li>
					<li className="count"><Link to="#"><img src={Image5} alt="Image"/></Link></li>
					<li className="count"><Link to="#"></Link></li>
					<li className="count"><Link to="#"></Link></li>
					<li className="previous text-end">
						<div className="content">Next</div>
						<h4 className="title"> <Link to="#">Mobile Application Design</Link> </h4>
					</li>
					</ul>
				</div>
				</div>
